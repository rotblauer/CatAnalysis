...
fact = .01
for (zoomy in c( seq(0, 10,by = 1), seq(11, 100,by = 4))) {
  zoomy = zoomy ^ 2
...
# 
# system(
#   "ffmpeg -framerate 1 -pattern_type glob -i './catImagesConv/*.png' -c:v libx264 -pix_fmt yuv420p -vf \"scale=300:300,format=yuv420p\" cat7.mp4 "
# )

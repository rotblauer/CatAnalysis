...
ggplot(loc_gc, aes(x = lon, y = lat,colour=clust6)) + geom_point()+ geom_density_2d()+t2
ggplot(loc_gc, aes(x = lon, y = elevation,colour=clust6)) + geom_point()+ geom_density_2d()+t2
ggplot(loc_gc, aes(x = lat, y = elevation,colour=clust6)) + geom_point()+ geom_density_2d()+t2


 
ggplot(loc_gc, aes(x = lon, y = lat,colour=clust6)) +  geom_density_2d()+t2
ggplot(loc_gc, aes(x = lon, y = elevation,colour=clust6)) +  geom_density_2d()+t2
ggplot(loc_gc, aes(x = lat, y = elevation,colour=clust6)) + geom_density_2d()+t2
# loc_gcP =loc_gc[which(loc_gc$clust6!=6),]
mfrow3d(nr = 1, nc = 1)
plot3d(loc_gc$lon, loc_gc$lat, loc_gc$elevation,col =loc_gc$clust6, size=2 )
# plot3d(loc_gcP$lon, loc_gcP$lat, loc_gcP$elevation,col =loc_gcP$clust6 )
...
clusterC = sort(unique(loc_gc$clust6))
for (c in clusterC) {
tp = loc_gc[which(loc_gc$clust6 == c),]
gp = ggplot(tp, aes(x = lon, y = lat, colour = clust6)) + geom_point() + geom_density_2d() +
t2 + ggtitle(label = paste("cluster=", c,"n=",length(tp$lon)))
print(gp)
gp = ggplot(tp, aes(x = lon, y = elevation, colour = clust6)) + geom_point() + geom_density_2d() +
t2 + ggtitle(label = paste("cluster=", c,"n=",length(tp$lon)))
print(gp)
gp = ggplot(tp, aes(x = lat, y = elevation, colour = clust6)) + geom_point() + geom_density_2d() +
t2 + ggtitle(label = paste("cluster=", c,"n=",length(tp$lon)))
print(gp)
gp = ggplot(tp, aes(x = lon, y = lat, colour = clust6)) +  geom_density_2d() +
t2 + ggtitle(label = paste("cluster=", c,"n=",length(tp$lon)))
print(gp)
gp = ggplot(tp, aes(x = lon, y = elevation, colour = clust6)) +  geom_density_2d() + t2 + ggtitle(label = paste("cluster=", c,"n=",length(tp$lon)))
print(gp)
gp = ggplot(tp, aes(x = lat, y = elevation, colour = clust6)) + geom_density_2d() + t2 + ggtitle(label = paste("cluster=", c,"n=",length(tp$lon)))
print(gp)
...
mfrow3d(nr = 1, nc = 1)
tp =loc_gc[which(loc_gc$clust6 == 4),]
t =plot3d(tp$lon,
tp$lat,
tp$elevation,
col = tp$clust6,
